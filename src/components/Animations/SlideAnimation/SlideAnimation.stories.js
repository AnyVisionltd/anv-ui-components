  ...
  return (
    <div style={{ height: '150px' }}>
      <div className={styles.marginFlexContainer}>
        <Button
          onClick={() => setSlide({ isOpen: !slide.isOpen, direction: 'up' })}
        >
          up
        </Button>
        <Button
          onClick={() =>
            setSlide({ isOpen: !slide.isOpen, direction: 'right' })
          }
        >
          right
        </Button>
        <Button
          onClick={() => setSlide({ isOpen: !slide.isOpen, direction: 'down' })}
        >
          down
        </Button>
        <Button
          onClick={() => setSlide({ isOpen: !slide.isOpen, direction: 'left' })}
        >
          left
        </Button>
      </div>
