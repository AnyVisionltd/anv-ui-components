...
ToastMessage.propTypes = {
  ...
  /** The icon at the end of the toastMessage, fire <code>onClose</code>. Set to false for remove. */
  closeIcon: propTypes.oneOfType([propTypes.element, propTypes.bool]),
  /** If <code>true</code> display the toastMessage. */
  isOpen: propTypes.bool,
  /**
   * The number of milliseconds to wait before automatically calling
   * the <code>onClose</code> function.
   * Timeout pause on hover and reset by leaving the toastMessage.
   * <code>onClose</code> should then set the state of the
   * <code>isOpen</code> prop to hide the ToastMessage.g
   ...
   * Typically onClose is used to set stoastMessagetate in the parent component,
